...
export default function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  const navItems = {
    ...
    admin: [
      ...
      { name: "List of Seniors", link: "/users-list" },
  ...
  return (
    <aside
      className={`fixed lg:static z-50 h-screen w-64 bg-gradient-to-b from-[#FF2424] to-[#8B1E2F] text-white transition-transform duration-300
